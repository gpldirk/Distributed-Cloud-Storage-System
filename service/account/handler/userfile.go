...
// UserFiles : 获取用户文件列表
func (user *User) UserFiles(ctx context.Context, req *proto.ReqUserFile, res *proto.RespUserFile) error {
...
// UserFiles : 用户文件重命名
func (user *User) UserFileRename(ctx context.Context, req *proto.ReqUserFileRename, res *proto.RespUserFileRename) error {
